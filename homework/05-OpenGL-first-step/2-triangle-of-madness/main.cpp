...
int main() {
  ...
  std::shared_ptr<void> context(
      SDL_GL_CreateContext(window.get()), [](SDL_GLContext context) {
  ...
  std::shared_ptr<char> vertex_shader_src, fragment_shader_src;
  {
    ...
    std::fstream fragment_shader_stream(fragment_shader_src_path, std::ios::in);
    ...
    fragment_shader_src =
        std::shared_ptr<char>(new char[fragment_shader_src_size]{}, deleter);

    vertex_shader_stream.read(vertex_shader_src.get(), vertex_shader_src_size);
...
GLuint create_shader(GLenum type, const char *src, char *compile_info,
                     GLuint buf_size) {
