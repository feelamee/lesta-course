...
void draw_triangle()
{
    ...
    size_t                radius = h * 9 / 10 / 2;

    using std::numbers::pi;
    for (float angle = 0; angle < 8 * pi; angle += pi / 16)
    {
        radius -= 3;
        triangles.push_back(
...
void rasterize_triangles()
{
    ...
    triangles.reserve(12 * pi / 16 * 2);
    for (float angle = 0; angle < 10 * pi; angle += pi / 16)
    {
        radius -= 3;
        triangles.push_back({
...
void black_white_triangle()
{
    ...
    std::vector<vertex> vertices = {
        { 40, 40, .6, .6, .6 },   { 600, 40, .6, .6, .6 },
        { 300, 150, 0., 0., 0. }, { 40, 320, .6, .6, .6 },
        { 600, 320, .6, .6, .6 }, { 300, 150, 0., 0., 0. }
    };
